...
class Multi_Japan extends StatefulWidget {
  var index;
  Multi_Japan(this.index);

  @override
  State<Multi_Japan> createState() => _Multi_JapanState();
}

class _Multi_JapanState extends State<Multi_Japan> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        body: StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection(_getGenre(widget.index)).snapshots(),
